...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        var types = ['text', 'hidden', 'number', 'password', 'email', 'textarea', 'file', 'date', 'time', 'button', 'checkbox', 'color', 'datetime-local', 'month', 'radio',
            'range', 'reset', 'search', 'submit', 'tel', 'url', 'week'];
...
'file'=>'file', 'date'=>'date', 'time'=>'time', 'button'=>'button', 'checkbox'=>'checkbox', 'color'=>'color', 'datetime-local'=>'datetime-local',
'month'=>'month', 'radio'=>'radio', 'range'=>'range', 'reset'=>'reset', 'search'=>'search', 'submit'=>'submit', 'tel'=>'tel', 'url'=>'url',
'week'=>'week'])
...
<div class="" id="">
    ...
    <div class="form-group col-sm-12">
        ...
        {!! Form::hidden('make_migration', 0, false) !!} <br>
